...
$JAVA_HOME/bin/java $FLIGHT_RECORDER $GC_ARGS -Dnv.ddl.profiles=$PROFILES -cp "libs/*" com.neeve.server.Main -n $SERVER $* 2>&1 | tee rdat/logs/$SERVER-server-$TIMESTAMP.log
