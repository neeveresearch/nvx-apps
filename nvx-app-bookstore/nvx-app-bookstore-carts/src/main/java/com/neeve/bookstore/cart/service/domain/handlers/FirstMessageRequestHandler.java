...
final public class FirstMessageRequestHandler implements MessageHandler<FirstRequest, AgentStartedEvent, com.neeve.bookstore.cart.service.repository.Repository> {
    ...
    final public MessageView handle(final String origin,
                                    ...
                                    final com.neeve.bookstore.cart.service.repository.Repository repository) throws Exception {
