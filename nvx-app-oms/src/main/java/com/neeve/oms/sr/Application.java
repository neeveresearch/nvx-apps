...
import com.neeve.oms.sr.boundary.NewOrderMessageExtractor;
import com.neeve.oms.sr.boundary.OrderEventPopulator;
import com.neeve.oms.messages.NewOrderMessage;
import com.neeve.oms.messages.OrderEvent;
import com.neeve.oms.state.Repository;
...
final public class Application {
     ...
     */
    @EventHandler
    final public void onNewOrder(final NewOrderMessage message, final Repository repository) {
        ...
        repository.getOrders().put(order.getOrderId(), order);
